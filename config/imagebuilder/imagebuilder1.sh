...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        liblucihttp liblucihttp-lua libubus-lua lua luci luci-base luci-lib-base luci-lib-ip luci-lib-jsonc luci-lib-nixio \
        ...
        mbim-utils qmi-utils uqmi umbim luci-proto-ncm \
